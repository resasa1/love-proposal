...
const AnnivPage = () => {
    ...
    useEffect(() => {
        console.log(now)
        //change date mypal
        if (now != "11/20/2024") { // must change to date to today (*dont forget to edit in CountdownPage.tsx. typing in find m'mypal* it will direct you to date edit)
            navigate('/wait')
        }
        else {
                    ...
                    <section className="grid h-screen w-full place-content-center bg-white">
                        <p className="flex flex-col items-center gap-2 text-3xl font-bold uppercase text-black">
                            <span className="grid place-items-center">
                                ...
                                Gerakin Mouse-nya :3</span>
                            <span className="text-sm font-normal text-center text-gray-600">
                                PAKAI LAPTOP/PC ATAU SET MODE DESKTOP DIBROWSER MOBILE YA BIAR KELIATAN JELAS HEHE 
                            </span>
                        </p>
                    </section>
                </MouseImageTrail>
